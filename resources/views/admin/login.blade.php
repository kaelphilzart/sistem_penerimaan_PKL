...
<body class=""style="background-color: 1589CF;">

<div class="container d-flex justify-content-center align-items-center vh-100">
    <div class="card pt-5 px-3 bg-hitam papan">
      <div class="circle-container">
        <div class="circle">
          <img src="{{ asset('img/logo-aptikma.png') }}" class="my-2 img-fluid" alt="Gambar Kecil">
        </div>
      </div>

      <div class="card-body ">
        <h3 class="card-title mb-4 text-center" style="color: #1589CF;"><b>Login</b></h3>
        <form class="mx-3 user"  role="form" method="POST" action="{{ route('login') }}">
          ...
          <button type="submit" class="btn btn-primary col-12 mt-3"
            style="background-color: #1589CF;color: #000; font-weight: bold;border-width: 0%;">LOGIN</button>
        </form>
        <p class="mt-3 mb-0 text-white text-center" style="font-size: smaller;">Don't have an account ? <a href="{{ route('register')}}"
            style="color: #1589CF;text-decoration: none;">Sign Up</a></p>
      </div>
    </div>
  </div>
